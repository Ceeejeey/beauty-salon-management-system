...
const AdminProfile = ({ setActiveComponent }) => (
  <div className="p-6 sm:p-10 font-poppins bg-gradient-to-br from-pink-50 to-white">
    <h2 className="text-3xl sm:text-4xl font-extrabold text-pink-700 mb-6 flex items-center">
      <FaUser className="mr-3 text-pink-500" /> Admin Profile
    </h2>
    <p className="text-gray-700 text-lg mb-8">Manage your admin profile information.</p>
    <div className="max-h-[calc(100vh-5rem)] overflow-y-auto">
      <div className="bg-white p-8 rounded-3xl shadow-xl border border-pink-100">
        <p className="text-gray-700">Profile management form will be implemented here.</p>
        <button
