...
const services = [
  ...
  },
  {
    ...
    description:
      "Indulge in a luxurious nail treatment for perfectly polished hands and feet.",
    price: "4000",
  ...
  },
  {
    ...
    description:
      "Rejuvenate your skin with our deep-cleansing and hydrating facial.",
    price: "60",
  ...
  return (
    <div className="p-6 sm:p-10 font-poppins bg-gradient-to-br from-pink-50 to-white">
      <h2 className="text-3xl sm:text-4xl font-bold text-pink-700 mb-6 flex items-center">
        <FaMedal className="mr-3 text-pink-500" /> The work you completed
        YesterDay,
      </h2>
          ...
          >
            <div className="relative h-48">
              <img
                ...
                onError={(e) =>
                  (e.target.src = `https://via.placeholder.com/300x200?text=LKR{service.title}`)
                }
              />
            </div>
            <div className="p-5">
              <span className="flex items-center text-pink-500 font-medium whitespace-nowrap ml-65">
                LKR {service.price}
              </span>
              <div className="flex items-center mb-0 mt-5 ml-5 px-3">
                {service.icon}
                <h3 className="ml-3 text-xl font-semibold text-pink-700">
                  {service.title}
                </h3>
              </div>
            </div>
