...
import BookAppointment from '../../components/customer/Appoinments'; // Fixed typo
...
const Profile = () => (
  <div className="p-6 sm:p-10 font-poppins bg-gradient-to-br from-pink-50 to-white">
    <h2 className="text-3xl sm:text-4xl font-extrabold text-pink-700 mb-6">Profile</h2>
...
const Dashboard = () => {
  ...
  const componentMap = {
    ...
    'Book Appointment': () => <BookAppointment setActiveComponent={setActiveComponent} />, // Fixed to use component reference
